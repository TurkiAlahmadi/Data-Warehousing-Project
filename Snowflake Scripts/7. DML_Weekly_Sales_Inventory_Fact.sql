...
INNER JOIN TPCDS.raw.DATE_DIM as date
on inventory.inv_date = date.d_date_sk
)
...
left join date_columns_in_inventory_table inv on inv_wk_num = sold_wk_num and inv_yr_num = sold_yr_num and item_sk = inv_item and inv_warehouse_sk = warehouse_sk
group by 1, 2, 4, 5
