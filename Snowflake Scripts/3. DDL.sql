...
-- Creating a Seperate Schema for Customer Snapshot
...
create or replace TABLE TPCDS.ANALYTICS.CUSTOMER_DIM (
	...
	INCOME_BAND_LOWER_BOUND NUMBER(38,0),
	INCOME_BAND_UPPER_BOUND NUMBER(38,0)
);
...
create or replace TABLE TPCDS.ANALYTICS.WEEKLY_CUSTOMER_COUNT (
    PURCHASE_WK_SK NUMBER(38,0),
    PURCHASE_WK_NUM NUMBER(38,0),
    PURCHASE_YR_NUM NUMBER(38,0),
    CATALOG_CUSTOMERS_WK NUMBER(38,0),
    WEB_CUSTOMERS_WK NUMBER(38,0)
);
...
create or replace TABLE TPCDS.INTERMEDIATE.DAILY_CUSTOMERS (
	CUSTOMER_SK NUMBER(38,0),
    PURCHASE_DATE_SK NUMBER(38,0),
    PURCHASE_WK_NUM NUMBER(38,0),
    PURCHASE_YR_NUM NUMBER(38,0),
    CATALOG_PURCHASE BOOLEAN,
    WEB_PURCHASE BOOLEAN
);
